...
export default class Forecast extends Component {
    ...
    componentDidMount() {
        ...
        axios.post('http://localhost:8081/factors')
            .then((res) => {
                this.setState({
                    factors: res.data
                })
    ...
    handleSubmit = (event) => {
        ...
        axios.post('http://localhost:8081/past', searchParams)
            .then((res) => {
                this.setState({
                    pastInfo: res.data
                })
        ...
        axios.post('http://localhost:8081/factorMultiplier', searchParams)
            .then((res) => {
    ...
    requestForecast = (searchParams) => {
        ...
        axios.post('hhttp://localhost:8081/forecast', payload)
            .then((res) => {
                this.setState({
