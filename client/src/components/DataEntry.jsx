...
export default class DataEntry extends Component {
  ...
  componentDidMount(){
    ...
    axios.post("http://localhost:8081/factorData")
    .then((res) => {  this.setState({factorOption: res.data}); })
    .catch(function(error){ if(!error.error); });

    axios.post("http://localhost:8081/skuMasterData")
    .then((res) => {  this.setState({skuData: res.data})  })
    .catch(function(error){ if(!error.error); });

    axios.post("http://localhost:8081/strMasterData")
  ...
  successfulSubmit = (obj) => {
    ...
    axios.post("http://localhost:8081/dataEntry", obj)
